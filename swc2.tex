...
\usepackage{candor, setspace, abstract, times, verbatim}
...
Foremost, we would like to thank our parents without whom we'd be
parentless. We'd like to thank our mentors, Dr. Donald L. Bitzer
(Distinguished University Professor), Dr. Anne-Marie Stomp (Associate
Professor of Forestry), and Dr. Mladen A. Vouk (Head of Computer
Science), for their guidance, support, and editing. We'd like to thank
Robert Snyder and Fred Breidt for their wet lab work. We'd also like
to thank Dr. Lalit Ponnala for his previous research and Scott Vu for
his debugging.
...
\noindent\BWFtitle{\emph}{~}; William G. Enloe High School, Raleigh, NC 27610
...
\begin{cfigure}
  ...
  \includegraphics[width=0.5\linewidth]{prfB/deterministic}
\end{cfigure}

\begin{cfigure}
  \caption{Plots of~\prfB: Polar plot}
  \label{prfB:polar:sub}
  \includegraphics[width=0.5\linewidth]{prfB/polar}
\end{cfigure}
...
\begin{cfigure}
  ...
  \label{prfB:disp:sub}
  \includegraphics[width=0.5\linewidth]{prfB/disp}
\end{cfigure}

\begin{cfigure}
  \caption{Plots of \prfB\ in a stochastic model: Sensitivity plot}
  \label{prfB:sens:sub}
  \includegraphics[width=0.5\linewidth]{prfB/sensitivity}
\end{cfigure}
...
\begin{cfigure}
  ...
  \label{ecoli:hist}
  \includegraphics[width=0.5\linewidth]{histograms/everything}
\end{cfigure}
...
\begin{cfigure}
  ...
  \includegraphics[width=0.5\linewidth]{histograms/ribosomal}
\end{cfigure}
...
\begin{cfigure}
  ...
  \label{bgh:disp}
  \includegraphics[width=0.5\linewidth]{bgh/all}
\end{cfigure}
...
\begin{cfigure}
  ...
  \includegraphics[width=0.5\linewidth]{linker/plasmid}
\end{cfigure}

\begin{cfigure}
  \caption{Linker sequence: Sensitivity plot}
  \label{linker:sens}
  \includegraphics[width=0.5\linewidth]{linker/sensitivity}
\end{cfigure}
