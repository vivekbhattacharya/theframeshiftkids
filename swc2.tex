...
deviation would correspond to a more efficient sequence.  We base this 
hypothesis on a To this end, we start with a simple fact:
Microbiologists agree that translation in \ecoli\ is an efficient process;
most regulation is transcriptional.  We hypothesize that displacement deviation
provides an accurate metric 
