...
\hyphenation{frame-shifts gen-bank da-ta-base}
...
\begin{cfigure}
  ...
  \subfloat[Displacement Plot]{
    \label{prfB:disp:sub}
    \includegraphics[width=0.45\textwidth]{prfB/disp}
  }
...
\begin{cfigure}
  ...
  \subfloat[Plasmid construct]{
    \label{linker:plasmid}
    \includegraphics[width=0.33\textwidth]{linker/plasmid}
  }
  \subfloat[Sensitivity plot]{
    \label{linker:sens}
    \includegraphics[width=0.40\textwidth]{linker/sensitivity}
  }
\end{cfigure}
...
be more efficient than average. Also, displacement deviations for seven of eight bGH
sequences~\cite{schoner:bgh} roughly correlate with further
