...
We propose the notion of {\emph{displacement deviation}}, defined as 
\begin{equation}
...
displacement per \autoref{section:frameshifts}.  Note that as
the displacement plot diverges from the horizontal axis (or any predicted frame),
$d$ increases.
...
As such, we predict that the sequences that are highly expressed in 
