...
rare codon usage~\cite{ikemura}~\cite{kane95}.  These sequence-dependent factors even apply to 
...
discussed in~\cite{lalit:jbsb} suggests that force arising from the free energy in such hybridizations acts as a correcting mechanism, helping to ensure that possible overshooting or 
...
the entire \ecoli\ genome to see if the model is robust over many different genes.
