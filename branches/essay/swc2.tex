...
\citet{lalit:mechanics} then represent the cumulative phasor
...
$x = \pm 1$~\cite{lalit:mechanics}.  In a deterministic model, we lack the
...
% LocalWords:  abcd abc bcd sp pcZ riboproteins disp aag guu efr ikemura
% LocalWords:  kane sd xray starmer aa TAV uga NCBI's Genbank lacZ
