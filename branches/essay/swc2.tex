...
\newcommand{\BWFauthors}{Hao Lian, Vivek Bhattacharya, and Daniel
  R. Vitek}
\newcommand{\subfigref}[1]{\hyperref[#1]{Figure~\ref{#1}}}
...
entire base pair in the mRNA sequence.  \subfigref{prfB:deterministic:sub}
...
Figure \autoref{prfB:disp:sub} shows a displacement plot for
\prfB, again with a distinctive jump at codon 25.
\footnote{Note that the polar plot is the the same as \subfigref{prfB:polar:sub}.
