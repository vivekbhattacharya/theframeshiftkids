...
\begin{abstract}
  ...
  sequences such as bovine growth horme, non-experimental verification of translational efficiency for man-made 
...
of human insulin in \ecoli\ epitmoizes the utility of this idea.  Yet, the
intricate details of protein translation are not fully understood; differentiating
between a high-yield and a low-yield sequence often amounts to tedious 
biological experimentation.  

To attack this problem, we wish to propose a stochastic
model for translation in the ribosome.  We study the applications
of this model as a means of screening for high-yield proteins without biological experimentation.
In addition, we analyze the applications of this model in the detection of ribosomal
frameshifts.
...
\begin{figure}
    ...
    \label{prfb:weiss}
    \subfloat[One Base Pair]{\includegraphics[scale=0.4]{prfb/weiss1}}
    \subfloat[Two Base Pairs]{\includegraphics[scale=0.4]{prfb/weiss2}}
\end{figure}
